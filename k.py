...
bot = telebot.TeleBot('7140244352:AAF9q36qeCnU9bt7eMQPNMiVP6cNbqulC1E')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "🚫 Unauthorized Access!🚫Please buy access :-@PAHADIOMP"
...
def welcome_start(message):
    ...
    response = f'''🫡WELCOME TO PAHADIOMP DDOS BOT 🚀 '''
    bot.reply_to(message, response)
...
def welcome_rules(message):
    user_name = message.from_user.first_name
    response = f'''
1. ANY PROBLEM DM HERE -> @PAHADIOMP'''
    bot.reply_to(message, response)
